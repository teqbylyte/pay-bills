...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Wallet = userHasOneWallet{
		...
		RelationField: field.NewRelation("Wallet", "model.Wallet"),
	}
...
func (a userHasOneWallet) Model(m *model.User) *userHasOneWalletTx {
	return &userHasOneWalletTx{a.db.Model(m).Association(a.Name())}
}

type userHasOneWalletTx struct{ tx *gorm.Association }

func (a userHasOneWalletTx) Find() (result *model.Wallet, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasOneWalletTx) Append(values ...*model.Wallet) (err error) {
...
func (a userHasOneWalletTx) Replace(values ...*model.Wallet) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneWalletTx) Delete(values ...*model.Wallet) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
